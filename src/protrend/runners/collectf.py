...
def extract_runner(spider: str = 'collectf', staging_area: Path = STAGING_AREA_PATH, version: str = '0.0.1'):
...
def transform_runner(transform: bool = True,
    ...
    connectors = [
        ...
        RegulatoryFamilyToRegulatorConnector(),
    ...
    regprecise_data_lake = DATA_LAKE_PATH.joinpath('collectf', '0.0.1')
...
if __name__ == "__main__":
    ...
    # LOGGER
    # ----------------------------------------------------
    log_file = log_file_from_name('collectf_transform')
